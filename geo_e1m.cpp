...
int main(){
	...
	cout << YELLOW <<"Функционал программы: "<< RESET << endl;
	cout << " " << endl;
	cout << YELLOW <<"[1] "<< WHITE <<"Прямая геодезическая задача" << endl;
	cout << YELLOW <<"[2] "<< WHITE <<"Обратная геодезическая задача" << endl;
	cout << YELLOW <<"[3] "<< WHITE <<"Расчёт дирекционного угла" << endl;
	cout << YELLOW <<"[4] "<< WHITE <<"Расчёт румбов" << endl;
	cout << YELLOW <<"[5] "<< WHITE <<"Расчёт проложения по Х" << endl;
	cout << YELLOW <<"[6] "<< WHITE <<"Расчёт проложения по Y" << endl;
	cout << " " << endl;
